...
instLine1       DB 'A/D, ARROWS OR MOUSE MOVE PADDLE',0
instLine2       DB 'PRESS P ANYTIME TO PAUSE OR RESUME',0
instLine3       DB 'BONUSES: SLOW, FAST, LIFE, WIDE',0
instLine4       DB 'DO NOT LET THE BALL FALL BELOW',0
levelSelectTitle DB 'SELECT LEVEL',0
level1Text       DB 'LEVEL 1 (SLOW)',0
level2Text       DB 'LEVEL 2 (MED)',0
level3Text       DB 'LEVEL 3 (FAST)',0
...
nextLevelText   DB 'PRESS ENTER OR CLICK FOR NEXT LEVEL',0
...
currentSpeed    DW 2
highScore       DW 0
highScoreName   DB 13 DUP(0)
highScoreValue  DB '00000',0
...
LSSDraw:
    ...
    mov dl, 14
    mov bl, 14
    mov si, OFFSET levelSelectTitle
    call PrintAt

    call DrawLevelMenuItems
...
LDM2:
    ...
    mov bl, 14
LDM3:
    mov si, OFFSET level3Text
    call PrintAt
    ret
DrawLevelMenuItems ENDP
...
HighScoresScreen PROC
    ...
    mov si, OFFSET highScoreName
    call PrintAt

    mov dh, 12
    mov dl, 25
    mov bl, 15             ; White Text
    mov si, OFFSET highScoreValue
    call PrintAt
...
TrySpawnBonus PROC
    ...
    inc bonusTypeCounter
    mov al, bonusTypeCounter
    and al, 3
    inc al
    mov bonusType, al
    mov bonusActive, 1
